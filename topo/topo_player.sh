...
endpoint  RecbeDecoder      in            type pull  method connect

endpoint  Recbe2Slowdash    in            type pull  method connect
...
# link      fltcoin           out            Sink              in

link      TFBFilePlayer     out            Sink              in

link      TFBFilePlayer     out            RecbeDecoder      in   
link      TFBFilePlayer     out            Recbe2Slowdash    in   
